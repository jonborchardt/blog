...
flowchart TB
  ...
  C --> D[4. AI claim extraction<br/>8-15 claims per video target]
...
<Figure caption="What 141 embedding-proposed candidate pairs actually turned out to be. Only the four gold classes — one strict logical contradiction, 7 debunks, 18 undercuts, 8 alternatives — surface as contradictions; the biggest bucket, same-claim, is agreement and feeds the consonance page; complementary and irrelevant are dropped.">
  <VizFigure
    ...
    data={{
      ...
      columns: ["Verdict", "Pairs", "Where it goes"],
      rows: [
        ["SAME-CLAIM", "63", "agreements page"],
        ["COMPLEMENTARY", "34", "dropped"],
        ["UNDERCUTS", "18", "contradictions page"],
        ["IRRELEVANT", "10", "dropped"],
        ["ALTERNATIVE", "8", "contradictions page"],
        ["DEBUNKS", "7", "contradictions page"],
        ["LOGICAL-CONTRADICTION", "1", "contradictions page"],
      ],
    }}
  >
