...
I do not treat agentic coding as "write a giant prompt and hope." I treat it as an engineering process for moving ambiguity out of my head and into code, validation, plans, and repository rules, in roughly that order. The workflow I actually follow looks like this:
