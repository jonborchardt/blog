...
hero:
  src: ./hero.png
  alt: A seven-rung ladder where each of the top six rungs branches off to a stop marker, and only the bottom rung leads to a small block of code
draft: false
---
...
- **The debt is labeled.** Search the repo for `ponytail:` and you get the honest list: the tower-width clamp heuristic, the accuracy-gate constants marked as tuning knobs. That's the whole backlog of deferred work, in-place, greppable.
