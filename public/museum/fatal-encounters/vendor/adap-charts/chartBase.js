        ...
        (function (_Charts) {
            ...
            */
            ...
            (function (ChartType) {
                ...
                ChartType[ChartType["filterGeoChoroplethChart"] = 5] = "filterGeoChoroplethChart";
                ChartType[ChartType["multiBarChart"] = 6] = "multiBarChart";
                ChartType[ChartType["pieChart"] = 7] = "pieChart";
                ChartType[ChartType["lineChart"] = 8] = "lineChart";
            ...
            function buildChart(chartBase, allKeys, allMetrics, allDimensions, xfilter, eventManager) {
                switch (chartBase.chartType) {
                    ...
                    case 5 /* filterGeoChoroplethChart */: {
                        return new _Charts.FilterGeoChoroplethChartViewModel(chartBase, allKeys, allMetrics, allDimensions, xfilter, eventManager);
                    }
                    case 6 /* multiBarChart */: {
                    ...
                    this.dataMapFunc = function (isAverage) {
                        ...
                        for (var metricIndex in _this.chartBase.metricIds) {
                            ...
                            ret.push({
                                ...
                                detail: _Charts.commaFormatter2(value)
                            });
                        }
                        ;
                        return ret;
            ...
            var AbstractFilterCoordinateGridChartViewModel = (function (_super) {
                ...
                function AbstractFilterCoordinateGridChartViewModel(chartBase, allKeys, allMetrics, allDimensions, xfilter, eventManager) {
                    ...
                    this.xAxisTicks = chartBase.xAxisTicks ? chartBase.xAxisTicks : Math.floor(this.width / 75);
                    this.yAxisTicks = chartBase.yAxisTicks ? chartBase.yAxisTicks : Math.floor(this.height / 26);
                ...
                AbstractFilterCoordinateGridChartViewModel.prototype.init = function (initExtension) {
                    ...
                    _super.prototype.init.call(this, function (c) {
                        ...
                        c.yAxis && c.yAxis().ticks && _this.yAxisTicks && c.yAxis().ticks(_this.yAxisTicks); // use tics for y because its all we have
