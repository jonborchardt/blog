...
5. Verify live: `https://jonborchardt.github.io/blog/<slug>/` renders; the homepage/archive list it; `https://jonborchardt.github.io/blog/rss.xml` includes it; paste the URL into a social preview tool to see the card. If the deploy failed, read the Actions log — it prints the same messages as the local build.
