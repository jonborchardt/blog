...
- `write-post` — scaffold with `npm run new-post`, write MDX with the shared primitives, mandatory visual pass (finds and builds the post's diagrams/charts via `create-visual`), validate/build; leaves `draft: true`.
