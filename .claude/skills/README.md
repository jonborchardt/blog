...
- `create-visual` — pictorial hand-drawn SVG → SVG chart → HTML/CSS → post-local React island decision tree (mermaid is banned; the build no longer renders it); house design language, VizFigure classify/wrap/name-and-summary rules and the visual a11y mistakes table.
